...
import argparse
import os
from ucmec_ppo_main import UCMEC
import utils
import TD3
import OurDDPG
import DDPG
...
if __name__ == "__main__":
	...
	parser.add_argument("--env", default="UCMEC")          # OpenAI gym environment name
	...
	for t in range(int(args.max_timesteps)):
		...
		done_bool = float(done) if episode_timesteps < env.episode_length else 0
